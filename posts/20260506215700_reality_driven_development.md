...
Subtitle: Or why specification is media about a solution, not the solution itself.
Date: 6 May 2026, Helsinki, Åndrei Makarov
Published: 2026-05-06T21:57:00+00:00
...
2026-05-01
  Pull request as capsule: intent, diff, checks, demo, risk note. What changed in the product, not what calmed the author.
2026-05-03
  Tool-calling models widen inspection; trust follows verification, not fluency. The chat surface only routes work.
2026-05-04
  When the patient in the room is the planner’s inner weather, the customer’s crossing waits in the mist. Name which session it is.
2026-05-06
  Specification after contact: compress the bruises. Specification before contact: sometimes scaffold, sometimes theater, and weight tells.
